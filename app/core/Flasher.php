...
class Flasher
{
  public static function setFlash($msg = 'insertMsg', $type = 'success', $action = '', $url = '#')
  {
  ...
  public static function flash()
  {
    ...
    $url = $_SESSION['flash']['url'];
    $icon = '';
    $htmlTagA = $action == '' ? '' : "<a href='$url'>$action</a>";

    $iconSrc  = '<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
